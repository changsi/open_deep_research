...
CORRECTNESS_PROMPT = """You are evaluating the correctness of a research report that was
generated by a research agent.

You will be provided with the user's question, the report, and the answer from
an independent authority.

Score the report from 1-5 on how well it mirrors the answer from the authority.
We expect the report to contain more information that is not in the answer; that
is okay. They will not be perfectly the same, but they should share the same
core themes and ideas to get a high score.

Use your best judgment when comparing the answer to the report.
...
Output format (JSON):
{
  "reasoning": "Brief explanation citing specific matches/mismatches",
  "score": 1 | 2 | 3 | 4 | 5
}
